...
export const SAT_IMPORT_SOURCES: SatImportSource[] = [
  {
    source: "SAT_ART_69",
    ...
    situation:
      "Contribuyente localizado en consulta pública de contribuyentes incumplidos.",
    riskLevel: "review",
    article: "69",
  },
  {
    ...
    listType: "presuntos",
    situation:
      "Contribuyente localizado en consulta pública de operaciones presuntamente inexistentes.",
    riskLevel: "review",
    article: "69-B",
  },
  {
    ...
    listType: "publicados",
    situation:
      "Contribuyente localizado en datos abiertos SAT de contribuyentes publicados.",
    riskLevel: "critical",
    article: "69-B Bis",
  },
  {
    ...
    situation:
      "Fuente pública contextual utilizada para justificar revisión preventiva.",
    riskLevel: "review",
    article: "49 Bis",
  },
];